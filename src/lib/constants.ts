 ...
 */
export const APP_NAME = "WhoCast";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = "Test your knowledge of your Farcaster friends";
 ...
 */
export const APP_TAGS = ["neynar", "social", "quiz"];
 ...
 */
export const APP_BUTTON_TEXT = "WhoCast your friends";
